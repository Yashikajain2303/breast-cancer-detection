      ...
      >
        <div
          className={classnames(
            'bg-[#702963] border-secondary-main relative flex items-center rounded border px-2 py-2 text-base text-white'
          )}
        >
          {message || (
            <>
              {children}
              <div className="border-[#e4b4db] ml-2 border-l pl-2">
                <Icon
                  name="clipboard"
