...
const classes = {
  Button: ({ isExpanded, primary }) =>
    classNames(
      baseClasses.Button,
      !isExpanded && !primary.isActive && 'hover:!bg-[#702963] hover:border-primary-dark'
    ),
    ...
    classNames(
      ...
      isActive
        ? isExpanded
          ...
          : 'border-[#e4b4db] bg-[#4d4c4d] border-2 rounded-md !p-2'
        : `focus:!text-black focus:!rounded-md focus:!border-[#e4b4db] focus:!bg-[#4d4c4d]
        ${isExpanded
          ? 'border-primary-dark bg-[#702963] !text-[#e4b4db]'
          : 'border-[#702963] bg-[#702963] group-hover/button:border-primary-dark group-hover/button:text-[#e4b4db] hover:!bg-[#702963] hover:border-primary-dark focus:!text-black'
        }
  `
    ),
