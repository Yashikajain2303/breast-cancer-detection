...
<div className="grid h-auto w-full grid-cols-4 gap-4 bg-gray-200 p-8">
  <div className="flex items-center space-x-2">
    <div className="bg-[#702963] h-16 w-16" />
    <span>primary-dark</span>
  </div>
  <div className="flex items-center space-x-2">
    <div className="bg-[#4d4c4d] h-16 w-16" />
...
```tsx
<div className="bg-[#4d4c4d] text-[#e4b4db]">OHIF UI Components</div>
```
...
<div className="grid h-auto w-full grid-cols-4 gap-4 bg-gray-200 p-8">
  ...
  <div className="flex items-center space-x-2">
    <div className="bg-[#1a0000] h-16 w-16" />
